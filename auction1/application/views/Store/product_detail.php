								...
								<div class="slick3 gallery-lb">
									<?php foreach ($pimages as $pimage):
										if ($p_id==$pimage->post_id) { ?>
											<div class="item-slick3" data-thumb="<?php echo base_url();?>uploads/shopkeepers_products/<?php echo $pimage->image ?>">
												<div class="wrap-pic-w pos-relative">
													<img style="background-color:#e5e6e8;" src="<?php echo base_url();?>uploads/shopkeepers_products/<?php echo $pimage->image ?>" alt="IMG-PRODUCT">

													<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo base_url();?>uploads/shopkeepers_products/<?php echo $pimage->image ?>">
						...
						<div class="col-md-6 col-lg-5 p-b-30">
							<div class="p-r-50 p-t-5 p-lr-0-lg">
								<?php foreach ($fetch_users as $user):
									if ($user->ID==$product->upload_by) {
										$s_name=$user->fullname;
										$s_id=$user->ID;
									}
								endforeach; ?>
								<?php if ($s_id!=$this->session->userdata('userID')): ?>
								...
								<h4 class="mtext-105 cl2 js-name-detail p-b-5">
									<?php echo $p_name=$product->product_name;?>
								</h4>


								<p class="stext-102 cl3 p-b-20">
									<?php echo $product->product_company;?>
								</p>
								...
								<p class="stext-102 cl3 p-t-23">
									Remaining Quanitity:&nbsp; <b>
										<?php  if ($product->quantity==0) {?>
											<b style="color:red;">Out of Stock</b>
										<?php } else{?>
											<text id="cquantity"> <?php echo $product->quantity;?></text></b>
										<?php } ?>
									</p>

									<p class="stext-102 cl3 p-t-23">
										Product By: &nbsp; <a href="<?php echo base_url();?>store/profile/<?php echo $s_id?>"><b><?php echo $s_name; ?></b></a>
									</p>

									<p class="stext-102 cl3 p-t-23">
										Date Added:&nbsp; <b><?php echo $product->upload_date;?></b>
									</p>

									<p class="stext-102 cl3 p-t-5">
										Location:&nbsp; <b><?php echo $product->location;?></b>
									</p>
									<?php if ($s_id!=$this->session->userdata('userID') && $this->session->userdata('usertype')!=2 && $i!=0) : ?>
										<?php echo form_open('store/user_cart');?>
										<p class="stext-102 cl3 p-t-23">Quantity:&nbsp; </p>
										<div class="wrap-num-product flex-w m-r-20 m-tb-10">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="fs-16 zmdi zmdi-minus"></i>
											</div>

											<input class="mtext-104 cl3 txt-center num-product" type="number" name="quantity" id="rquantity" onchange='check_quantity()' name="num-product" value="1">
										...
										<div class="size-100 flex-w flex-m respon6-next m-t-20">
											...
											if ($i==1) {
												if($name->usertype==3){ ?>
													...
													<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 trans-04 js-addcart-detail" type="submit" id="addcart">
														Add to cart
													</button>
													  <?php echo form_close();?>
													<i class="flex-c-m m-l-25 stext-101 cl0 size-101 bg5 bor1 hov-btn1 trans-04" data-toggle="modal" data-target="#modal-bid">
														Bid History
													</i>
					...
					<section class="sec-relate-product bg0 p-t-45 p-b-105">
						<div class="container">
							...
							<div class="wrap-slick2">
								<div class="slick2">
									<?php foreach ($fetch_Relatedproducts as $product): if($p_id!=$product->product_id){ ?>
													...
													<?php foreach ($f_image as $image):
														...
														{ ?>
															<a href="<?php echo base_url();?>store/p_detail/<?php echo $product->product_id;?>/<?php echo $product->product_name;?>/<?php echo $product->product_company;?>">
																<img style="background-color:#e5e6e8; width:250px; height:260px;" src="<?php echo base_url();?>uploads/shopkeepers_products/<?php echo $image->image;?>" alt="IMG-PRODUCT"></a>
															<?php } endforeach;?>
														</div>
												...
												<div id="existing" style="display:block;">
													...
													<select class="form-control" name="new_id_product" required>
														...
														<?php foreach ($products as $p):
															if ($company_name==$p->product_company) {
															if ($this->session->userdata('userID')==$p->upload_by) {?>
																<option value="<?php echo $p->product_id;?>"><?php echo $p->product_name."&nbsp&nbsp&nbsp Price: " .$p->product_price?></option>
															<?php } } endforeach; ?>
														</select>
